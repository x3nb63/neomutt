 ...
 */
static int icmd_quit(struct Buffer *buf, struct Buffer *s, unsigned long data, struct Buffer *err)
{
...
static int icmd_help(struct Buffer *buf, struct Buffer *s, unsigned long data, struct Buffer *err)
{
...
static int icmd_color(struct Buffer *buf, struct Buffer *s, unsigned long data, struct Buffer *err)
...
static int icmd_messages(struct Buffer *buf, struct Buffer *s, unsigned long data, struct Buffer *err)
{
...
static int icmd_scripts(struct Buffer *buf, struct Buffer *s, unsigned long data, struct Buffer *err)
{
...
static int icmd_vars(struct Buffer *buf, struct Buffer *s, unsigned long data, struct Buffer *err)
{
